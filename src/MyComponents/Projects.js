        ...
        <>
            <div className="container2">
                <div className="project">
                    ...
                    <img style={img} src={todolist} /* height="200px" */ width="300px" className="rounded" alt="Todo List pic" />
                    <p style={desc}>A simple Todo List build using React to list down our task .Allowing users to store their day to day task.</p>
                ...
                <div className="project">
                    ...
                    <img style={img} src={votedapppic} /* height="200px" */ width="300px" className="rounded" alt="Vote Dapp pic" />
                    <p style={desc}>Online Voting Dapp(Decentralized Application) using Ethereum Blockchain. Here, a user can cast their votes for their favorite candidate from anywhere in world at anytime.</p>
                ...
                <div className="project">
                    ...
                    <img style={img} src={filestor} width="300px" className="rounded" alt="File Storage pic" />
                    <p style={desc}>
                ...
                <div className="project">
                    ...
                    <img style={img} src={atm} width="300px" className="rounded" alt="atm pic" />
                    <p style={desc}>This is a ATM simulator in java. Various atm services are available in this project. User can withdraw, deposit, transfer and can the change pin.</p>
                ...
                <div className="project">
                    ...
                    <img style={img} src={hospmng} width="300px" className="rounded" alt="Hospital management pic" />
                    <p style={desc}>Hospital Management software in python. UI is made using Tkinter library with support of mysql as a database to store records.</p>
