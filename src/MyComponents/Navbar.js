            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link active text-white" aria-current="page" to="/about">About Me</Link>
                        </li>
                        <li className="nav-item">
                    ...
                    <div className="d-flex" id="logo">
                        ...
                        <a href="https://www.linkedin.com/in/neeraj-salunke/" target="_blank" className="logo">
                        ...
                        <a href="https://twitter.com/NeerajSalunke15" target="_blank" className="logo">
